...
exports.onJobPostingCreated = exports.onApplicationStatusChange = void 0;
...
exports.onJobPostingCreated = functions.firestore
    ...
    try {
        ...
        for (const staffDoc of staffSnapshot.docs) {
            ...
            const availabilityData = (_a = availabilityDoc.data()) === null || _a === void 0 ? void 0 : _a.schedule;
            if (!availabilityData) {
